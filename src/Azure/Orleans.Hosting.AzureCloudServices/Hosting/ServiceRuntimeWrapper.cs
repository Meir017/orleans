    ...
    internal partial class ServiceRuntimeWrapper : IServiceRuntimeWrapper, IDeploymentConfiguration
    {
        ...
        public IPEndPoint GetIPEndpoint(string endpointName)
        {
            ...
            catch (Exception exc)
            {
                ...
                LogSiloEndpointConfigError(exc, RoleName, endpointName, endpointNames);
        ...
        private void Initialize()
        {
            ...
            if (assembly == null)
            {
                LogAzureServiceRuntimeNotLoaded();
...
#pragma warning restore 618
                if (assembly == null)
                {
                    LogAzureServiceRuntimeFailedToLoad();
        ...
        private partial void LogAzureServiceRuntimeNotLoaded();
        ...
        private partial void LogAzureServiceRuntimeFailedToLoad();
        ...
        private partial void LogSiloEndpointConfigError(Exception exc, string roleName, string endpointName, string endpointNames);
    }
}
