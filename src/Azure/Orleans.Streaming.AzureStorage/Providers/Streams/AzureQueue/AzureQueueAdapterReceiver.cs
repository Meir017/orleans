    ...
    internal partial class AzureQueueAdapterReceiver : IQueueAdapterReceiver
    {
        ...
        public async Task MessagesDeliveredAsync(IList<IBatchContainer> messages)
        {
            try
            {
                ...
                {
                    LogWarningDeleteQueueMessageException(exc, this.azureQueueName);
                }
            }
            finally
            {
        ...
        private partial void LogWarningDeleteQueueMessageException(Exception exc, string queueName);
