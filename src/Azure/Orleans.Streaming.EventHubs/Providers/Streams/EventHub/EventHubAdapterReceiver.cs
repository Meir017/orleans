...
namespace Orleans.Streaming.EventHubs
{
    ...
    internal partial class EventHubAdapterReceiver : IQueueAdapterReceiver, IQueueCache
    {
        ...
        {
            LogInformationInitializingEventHubPartition(this.settings.Hub.EventHubName, this.settings.Partition);
        ...
        public async Task Shutdown(TimeSpan timeout)
        {
            ...
            try
            {
                ...
                LogInformationStoppingReadingFromEventHubPartition(this.settings.Hub.EventHubName, this.settings.Partition);
        ...
        private partial void LogInformationInitializingEventHubPartition(string eventHubName, string partition);
        ...
        private partial void LogInformationStoppingReadingFromEventHubPartition(string eventHubName, string partition);
    }
}